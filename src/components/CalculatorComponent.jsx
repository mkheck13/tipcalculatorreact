                ...
                <div className='w-full md:w-1/2'>
                    <div className='md:pl-10 md:pr-3 py-6'>
                        ...
                        <div className='relative'>
                            ...
                            <input value={bill === 0 ? '' : bill} type='number' placeholder='0' className='bg-lightGray h-12 rounded-xl text-xl text-right pr-5 w-full' onChange={(e) => setBill(parseFloat(e.target.value))} min={0} onKeyDown={(evt) => ['e', 'E', '+', '-'].includes(evt.key) && evt.preventDefault()} />
                        </div>
                    </div>
                    ...
                    <div className='md:pl-10 pr-3 py-6'>
                        ...
                        <div className='relative'>
                            ...
                            <input value={people === 0 ? '' : people} type='number' placeholder='0' className='bg-lightGray h-12 rounded-xl text-xl text-right pr-5 w-full' onChange={(e) => setPeople(parseFloat(e.target.value))} min={0} onKeyDown={(evt) => ['e', 'E', '+', '-'].includes(evt.key) && evt.preventDefault()} />
                        </div>
                    </div>
                </div>
